            ...
            'google_places' => [
                ...
                'keys'        => [
                    ...
                    [
                        ...
                        'masked_value'  => ApiKeysMasker::resolveValue('GOOGLE_PLACE_ID', $localData, $config) ?: '',
            ...
            'tripadvisor' => [
                ...
                'keys'        => [
                    ...
                    [
                        ...
                        'masked_value'  => ApiKeysMasker::resolveValue('TRIPADVISOR_LOCATION_ID', $localData, $config) ?: '',
                        'description'   => 'Identificador de ubicación en TripAdvisor.',
                    ],
                ],
            ],
            'telegram' => [
